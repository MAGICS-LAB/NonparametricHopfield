...
class BigBirdBlockSparseAttention(nn.Module):
    def __init__(self, d_model, n_heads, d_keys=None, d_values=None, mix=True, update_steps=1, dropout = 0.1, mode='softmax', scale=None, random_blocks=1, block_size=None):
        super().__init__()
        ...
        self.num_random_blocks = random_blocks
        self.block_size = block_size

        self.attention_head_size = d_keys
        self.all_head_size = n_heads * d_keys
        self.scale = scale or 1./sqrt(E)
