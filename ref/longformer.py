...
from utils.sliding_chunks import *
...
class LongformerSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        self.head_dim = config["d_keys"] #   int(config.hidden_size / config.num_attention_heads)
        ...
        self.attention_window = config["win_size"]
        self.attention_dilation = config["dil_size"]
    ...
    def forward(
        ...
        if self.attention_mode == 'tvm':
            ...
            attn_weights = diagonaled_mm(q, k, self.attention_window, self.attention_dilation, False, 0, False)
        ...
        if remove_from_windowed_attention_mask is not None:
            ...
            if self.attention_mode == 'tvm':
                d_mask = diagonaled_mm(ones, float_mask, self.attention_window, self.attention_dilation, False, 0, False)
            elif self.attention_mode == "sliding_chunks":
        ...
        if self.attention_mode == 'tvm':
            ...
            attn += diagonaled_mm(attn_probs, v, self.attention_window, self.attention_dilation, True, 0, False)
        elif self.attention_mode == "sliding_chunks":
